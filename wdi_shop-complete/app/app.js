...
var currentDate = new Date();
        var shittyDay = new Date('2015/02/25');
        console.log("Today is " + currentDate.toDateString());

        if((currentDate.getDate() == shittyDay.getDate()) && (currentDate.getMonth() == danielsBirthday.getMonth())){
        	console.log("Today is a Shitty Day... Fuck Today!");
 		}else{
 			console.log("Today is not as shitty as " + shittyDay)
 		}